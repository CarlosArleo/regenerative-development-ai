...
## [The Experimental Validation: N=36 Study](https://github.com/CarlosArleo/regenerative-ai-architecture/tree/main/docs/assets/Constitutional%20AI) *(full report and data)*
...
******[**→ View All Diagrams & Guides**](https://github.com/CarlosArleo/regenerative-development-ai/tree/main/docs/visuals)******

### Quick Visual Reference

**-****[**Complete Process Flow**](https://github.com/CarlosArleo/regenerative-development-ai/blob/main/docs/visuals/process-flow-diagram.md)****** - All 4 stages at a glance

**-****[**Actor Interactions**](https://github.com/CarlosArleo/regenerative-development-ai/blob/main/docs/visuals/actor-interaction-diagram.md)****** - How Community, Practitioner, and AI work together

**-****[**VDK Architecture**](https://github.com/CarlosArleo/regenerative-development-ai/blob/main/docs/visuals/vdk-architecture-diagram.md)****** - How we prevent extractive governance

**-****[**Constitutional Principles**](https://github.com/CarlosArleo/regenerative-development-ai/blob/main/docs/visuals/seven-principles-diagram.md)****** - The framework that guides everything

#### The Process (Summary)

**1.****Stage 1****** (2-3 weeks) - Generate Inquiry Questions
**2.****Stage 2****** (1 week) - Process Responses & Validate Essence
**3.****Stage 3****** (1 week) - Create Design Brief
**4.****Stage 4****** (1 week) - Generate & Choose Governance Pathways
...
| View                       | Purpose                                | Link                                                   |
| -------------------------- | -------------------------------------- | ------------------------------------------------------ |
| **Actor Layers**     | Understand who does what at each stage | [View Diagram](docs/images/actor-interaction-diagram.svg) |
| **VDK Architecture** | Deep dive into constitutional AI       | [View Diagram](docs/images/vdk-architecture-diagram.svg)  |
| **Mermaid Flow**     | GitHub-compatible version              | [View in Markdown](#mermaid-version)                      |
...
**Project Repository:** [[GitHub URL](https://github.com/CarlosArleo/regenerative-development-ai)]
**Documentation:** [docs/](https://github.com/CarlosArleo/regenerative-development-ai/tree/main/docs)
**Contact:** [c.arleo@localis-ai.uk](c.arleo@localis-ai.uk)
**Community:** [forum/discord/signal] soon
